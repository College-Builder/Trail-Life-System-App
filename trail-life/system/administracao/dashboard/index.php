  ...
  <body>
        ...
        <div>
          ...
          <div>
            <ul>
              <li>
                <button
                  aside-menu-container__option
                  for-dashboard-panel="1"
                  class="--default-text-hover-animation --on"
                >
              ...
              <li>
                <button
                  aside-menu-container__option
                  for-dashboard-panel="2"
                  class="--default-text-hover-animation"
                >
                  <i class="bi bi-box-seam"></i>
                  <i>Entregas</i>
                </button>
    ...
    <main>
      <div class="dashboard-system-container">
        ...
        <!---->
        <div
          dash-board-menu-container
          class="dashboard-system-container__aside-menu-container"
        ></div>
        <!---->
        <!---->
        <div class="dashboard-system-container__dashboard-container">
          <div
            dashboard-panel-id="1"
            class="--on"
