...
try {
      ...
      $validateClienteData->validateId($id);
      ...
      $sql = 'UPDATE clientes SET empresa = ?, cnpj = ?, estado = ?, cidade = ?, rua = ?, numero = ?, celular = ?, email = ? WHERE id = ?;';
      $params = array($empresa, $h_cnpj, $h_estado, $h_cidade, $h_rua, $h_numero, $h_celular, $h_email, $id);
